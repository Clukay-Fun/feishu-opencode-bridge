...
- 当前项目版本：`0.2.0`
- 发布记录维护在 [CHANGELOG.md](/Users/clukay/Program/feishu-opencode-bridge/CHANGELOG.md)
- 后续版本号按 SemVer 维护：
  修复或纯文档更新用 `patch`，向后兼容的新能力用 `minor`，破坏性调整用 `major`
- 准备发版时，`package.json`、`package-lock.json`、`CHANGELOG.md` 需要一起更新
