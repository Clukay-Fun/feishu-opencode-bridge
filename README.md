...
[![测试](https://img.shields.io/badge/tests-457%20passing-success)](#%EF%B8%8F-开发命令)
...
- **2026-04-28** · 外部扩展进入受限加载阶段：公开 `extension-api`、启动期 manifest/config 归一化和外部 RuntimeModule 适配，同时继续禁止热拔插和直接依赖 bridge 内部
...
当前完整验证基线：**64 test files · 457 tests passing**
