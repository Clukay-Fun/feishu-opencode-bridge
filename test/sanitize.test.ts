...
describe("redactEvidenceText", () => {
  it("redacts common personal identifiers in free text", () => {
    const value = redactEvidenceText("姓名：张三 联系方式：13812345678 身份证号：310101199001011234 邮箱：zhangsan@example.com");
    expect(value).toContain("姓名：张*");
